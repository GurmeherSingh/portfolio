                ...
                <div className="h-full overflow-y-auto p-8">
                  <div className="max-w-2xl mx-auto">
                    ...
                    <div className="space-y-6 text-gray-800">
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <ul className="text-gray-500 text-sm mt-1 list-disc list-inside">
                              ...
                              <li>Contributed to 40% increase in user engagement</li>
                            </ul>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        <h2 className="text-xl font-bold border-b-2 border-orange-400 mb-3">Skills</h2>
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            <h3 className="font-semibold">Programming Languages</h3>
                            <p className="text-gray-600 text-sm">JavaScript, TypeScript, Python, Java</p>
                          </div>
                          <div>
                            <h3 className="font-semibold">Frameworks & Tools</h3>
                            <p className="text-gray-600 text-sm">React, Node.js, AWS, MongoDB</p>
                          </div>
                        </div>
                      </div>
                    </div>
